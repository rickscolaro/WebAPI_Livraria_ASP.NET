...
insert into LivrosInfo(Descricao, Paginas, Editora, LivroId) values ('O livro trata a respeito de criação de APIs com Node.js, levando ao leitor os principais conceitos necessários para a implementação', 250, 'Editora IGTI', 1);
insert into LivrosInfo(Descricao, Paginas, Editora, LivroId) values ('O livro passa uma visão geral sobre o JavaScript moderno, quais as principais estruturas e exemplos de utilização', 350, 'Editora IGTI', 2);
insert into LivrosInfo(Descricao, Paginas, Editora, LivroId) values ('O livro demonstra na prática a utilização do Express em conjunto com o Node.js para criação de APIs', 150, 'Editora IGTI', 3);
insert into LivrosInfo(Descricao, Paginas, Editora, LivroId) values ('O livro aborda na teoria e na prática os bancos de dados relacionais, desde a sua motivação até a construção e consulta de registros', 450, 'Editora IGTI', 4);
insert into LivrosInfo(Descricao, Paginas, Editora, LivroId) values ('O livro faz uma introdução aos bancos de dados NoSQL, em especial os bancos de dados orientados a documentos', 100, 'Editora IGTI', 5);
insert into LivrosInfo(Descricao, Paginas, Editora, LivroId) values ('O livro aborda na teoria a importância e utilização da autorização e autenticação em APIs com Node.js e Express', 90, 'Editora IGTI', 6);